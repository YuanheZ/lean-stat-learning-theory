...
theorem gaussian_logSobolev_W12_real {f : ℝ → ℝ}
  ...
  have h_entropy_le :
    ...
    simpa [GaussianPoincare.stdGaussianMeasure, ProbabilityTheory.stdGaussian, μ, qk] using h
  ...
  simpa [GaussianPoincare.stdGaussianMeasure, ProbabilityTheory.stdGaussian, μ, q] using h_final

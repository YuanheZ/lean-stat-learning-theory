...
\urlstyle{tt}
\newcommand{\lean}[1]{{\small\path{#1}}}
\setlength{\emergencystretch}{2em}


\title{NNGPResNet: IID and Correlated-Layer Bounds}
...
\section{Relation to Recent ArXiv Work}
\subsection{Inverse-depth scaling and effective depth}
The IID model yields $\operatorname{Var}(M_u)=1/L^2$ for $\|u\|=1$, reflecting both the ResNet scaling $1/\sqrt L$ in each layer increment and the explicit depth average $1/L$.
The correlated model replaces $L^2$ by the effective depth
$D_{\mathrm{eff}}=L^3/\rho_{\mathrm{sum}}$, which interpolates between $D_{\mathrm{eff}}=L^2$ (independent layers) and $D_{\mathrm{eff}}=L$ (perfectly correlated layers).
This formalizes, in a Gaussian-process setting, the same qualitative mechanism proposed in \cite{liu2026inverse}: when most layers are functionally similar, depth behaves like averaging over fewer effectively independent contributions, producing inverse-depth-type scaling governed by an effective depth rather than the nominal depth.

\subsection{Lean formalization of empirical-process tools}
The sphere-process bounds in Theorems~\ref{thm:iid-t2-centered} and~\ref{thm:iid-t2-uncentered} are applications of Dudley’s entropy integral theorem for sub-Gaussian processes.
The explicit Dudley constant $12\sqrt 2$ and the entropy-integral interface used here align with the Lean 4 empirical-process infrastructure developed in \cite{zhang2026sltlean}, which formalizes Dudley’s theorem for sub-Gaussian processes (and related Gaussian concentration tools) in Lean.
The present note specializes these tools to the NNGPResNet sphere process and records a one-to-one correspondence with the concrete Lean declarations used in our development.
...
\begin{itemize}
\item Residual width $rm=r m$: \lean{LeanSlt.NNGPResNet.residualWidth} --- \lean{LeanSlt/NNGPResNet/Defs.lean}
\item Sign activation $\operatorname{sign}$: \lean{LeanSlt.NNGPResNet.signAct} --- \lean{LeanSlt/NNGPResNet/Defs.lean}
\item Layer increment $\Delta h_\ell$: \lean{LeanSlt.NNGPResNet.DeltaH} --- \lean{LeanSlt/NNGPResNet/Defs.lean}
\item Layer probe $g_\ell(u)$: \lean{LeanSlt.NNGPResNet.g} --- \lean{LeanSlt/NNGPResNet/Defs.lean}
\item Depth average $M_u$: \lean{LeanSlt.NNGPResNet.M_u} --- \lean{LeanSlt/NNGPResNet/Defs.lean}
\item Averaged vector $W$: \lean{LeanSlt.NNGPResNet.W} --- \lean{LeanSlt/NNGPResNet/Defs.lean}
\item Sphere type $S^{m-1}$: \lean{LeanSlt.NNGPResNet.Sphere} --- \lean{LeanSlt/NNGPResNet/Defs.lean}
\item Process $X(u)=\langle u,W\rangle$: \lean{LeanSlt.NNGPResNet.X} --- \lean{LeanSlt/NNGPResNet/Defs.lean}
\item Bridge $M_u=X(u)$: \lean{LeanSlt.NNGPResNet.M_u_eq_X} --- \lean{LeanSlt/NNGPResNet/Defs.lean}
\item Bridge $M_u=\langle u,W\rangle$: \lean{LeanSlt.NNGPResNet.M_u_eq_inner_W} --- \lean{LeanSlt/NNGPResNet/Defs.lean}
\end{itemize}

\subsection*{IID scalar results (T1)}
\begin{itemize}
\item Gaussian law: \lean{LeanSlt.NNGPResNet.scalar_mean_map_gaussian} --- \lean{LeanSlt/NNGPResNet/Scalar.lean}
\item Tail bound: \lean{LeanSlt.NNGPResNet.scalar_mean_tail} --- \lean{LeanSlt/NNGPResNet/Scalar.lean}
\item Second moment: \lean{LeanSlt.NNGPResNet.scalar_mean_mse} --- \lean{LeanSlt/NNGPResNet/Scalar.lean}
\end{itemize}

\subsection*{IID sphere process, entropy, Dudley, high probability (T2/T3)}
\begin{itemize}
\item Sphere set and subtype bridge: \lean{sphereSet}, \lean{SphereSetSub}, \lean{sphereEquivSphereSetSub} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Increment Gaussian law: \lean{LeanSlt.NNGPResNet.map_X_diff_gaussian} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Sub-Gaussian process instance: \lean{LeanSlt.NNGPResNet.sphere_process_isSubGaussian} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Sphere entropy finiteness: \lean{LeanSlt.NNGPResNet.entropyIntegralENNReal_sphere_ne_top} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Sphere entropy bound $\le 4\sqrt m$: \lean{LeanSlt.NNGPResNet.entropyIntegral_sphere_le} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Dudley intermediate bound: \lean{LeanSlt.NNGPResNet.sphere_process_expected_sup_bound_entropy} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Entropy-assuming intermediate theorem: \lean{LeanSlt.NNGPResNet.sphere_process_expected_sup_bound_assuming_entropy} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Final unconditional IID-T2 theorem: \lean{LeanSlt.NNGPResNet.sphere_process_expected_sup_bound} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Coordinate bridge: \lean{LeanSlt.NNGPResNet.W_coord_eq_M_u_single} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Supremum event reduction to coordinates: \lean{LeanSlt.NNGPResNet.sphere_sup_event_subset_union_coords} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Integrability and positivity helpers used in T3 proof path: \lean{LeanSlt.NNGPResNet.integrable_supX}, \lean{LeanSlt.NNGPResNet.supX_nonneg} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\item Final IID-T3 theorem: \lean{LeanSlt.NNGPResNet.sphere_process_highProb_bound} --- \lean{LeanSlt/NNGPResNet/SphereChaining.lean}
\end{itemize}

\subsection*{Correlated definitions and effective depth}
\begin{itemize}
\item Correlation kernel $\rho$: \lean{LeanSlt.NNGPResNet.Correlated.rho} --- \lean{LeanSlt/NNGPResNet/Correlated/Defs.lean}
\item Correlation sum $\rho_{sum}$: \lean{LeanSlt.NNGPResNet.Correlated.rhoSum} --- \lean{LeanSlt/NNGPResNet/Correlated/Defs.lean}
\item Inverse effective depth $\rho_{sum}/L^3$: \lean{LeanSlt.NNGPResNet.Correlated.invDEff} --- \lean{LeanSlt/NNGPResNet/Correlated/Defs.lean}
\item Effective depth $L^3/\rho_{sum}$: \lean{LeanSlt.NNGPResNet.Correlated.D_eff} --- \lean{LeanSlt/NNGPResNet/Correlated/Defs.lean}
\item Layer probe $g_\ell^{corr}$: \lean{LeanSlt.NNGPResNet.Correlated.gCorr} --- \lean{LeanSlt/NNGPResNet/Correlated/Defs.lean}
\item Layer-average statistic: \lean{LeanSlt.NNGPResNet.Correlated.M_u_corr_layerAvg} --- \lean{LeanSlt/NNGPResNet/Correlated/Defs.lean}
\item Flattened statistic: \lean{LeanSlt.NNGPResNet.Correlated.M_u_corr} --- \lean{LeanSlt/NNGPResNet/Correlated/Defs.lean}
\item Bridge lemma: \lean{LeanSlt.NNGPResNet.Correlated.M_u_corr_layerAvg_eq_M_u_corr} --- \lean{LeanSlt/NNGPResNet/Correlated/Defs.lean}
\item Correlated averaged vector and process: \lean{LeanSlt.NNGPResNet.Correlated.Wcorr}, \lean{LeanSlt.NNGPResNet.Correlated.XCorr} --- \lean{LeanSlt/NNGPResNet/Correlated/Defs.lean}
\end{itemize}

\subsection*{Correlated covariance/variance/scalar results}
\begin{itemize}
\item Single-layer Gaussian map: \lean{LeanSlt.NNGPResNet.Correlated.map_gCorr_gaussian_any} --- \lean{LeanSlt/NNGPResNet/Correlated/GaussianLinearForms.lean}
\item Single-layer variance: \lean{LeanSlt.NNGPResNet.Correlated.variance_gCorr} --- \lean{LeanSlt/NNGPResNet/Correlated/GaussianLinearForms.lean}
\item Variance of layer sum: \lean{LeanSlt.NNGPResNet.Correlated.variance_gCorr_add} --- \lean{LeanSlt/NNGPResNet/Correlated/GaussianLinearForms.lean}
\item Covariance formula (CORR-COV): \lean{LeanSlt.NNGPResNet.Correlated.cov_gCorr} --- \lean{LeanSlt/NNGPResNet/Correlated/GaussianLinearForms.lean}
\item Unit-vector Gaussian law (layerAvg): \lean{LeanSlt.NNGPResNet.Correlated.corr_scalar_map_gaussian_unit_layerAvg} --- \lean{LeanSlt/NNGPResNet/Correlated/Scalar.lean}
\item Unit-vector tail (layerAvg): \lean{LeanSlt.NNGPResNet.Correlated.corr_scalar_tail_layerAvg} --- \lean{LeanSlt/NNGPResNet/Correlated/Scalar.lean}
\item Unit-vector MSE (layerAvg): \lean{LeanSlt.NNGPResNet.Correlated.corr_scalar_mse_layerAvg} --- \lean{LeanSlt/NNGPResNet/Correlated/Scalar.lean}
\item Variance from covariance sum: \lean{LeanSlt.NNGPResNet.Correlated.var_M_u_corr_layerAvg_as_covariance_sum} --- \lean{LeanSlt/NNGPResNet/Correlated/Scalar.lean}
\item Variance in explicit $\rho$-sum form: \lean{LeanSlt.NNGPResNet.Correlated.var_M_u_corr_layerAvg_as_rho_sum} --- \lean{LeanSlt/NNGPResNet/Correlated/Scalar.lean}
\end{itemize}

\subsection*{Correlated chaining and high-probability supremum}
\begin{itemize}
\item Centered correlated process: \lean{LeanSlt.NNGPResNet.Correlated.centeredCorrProcess} --- \lean{LeanSlt/NNGPResNet/Correlated/SphereChaining.lean}
\item Correlated Dudley entropy form: \lean{LeanSlt.NNGPResNet.Correlated.corr_sphere_expected_sup_bound_entropy} --- \lean{LeanSlt/NNGPResNet/Correlated/SphereChaining.lean}
\item Correlated expected sup bound (flat form): \lean{LeanSlt.NNGPResNet.Correlated.corr_sphere_expected_sup_bound} --- \lean{LeanSlt/NNGPResNet/Correlated/SphereChaining.lean}
\item Correlated expected sup bound (layerAvg form): \lean{LeanSlt.NNGPResNet.Correlated.corr_sphere_expected_sup_bound_layerAvg} --- \lean{LeanSlt/NNGPResNet/Correlated/SphereChaining.lean}
\item Coordinate bridge for correlated process: \lean{LeanSlt.NNGPResNet.Correlated.Wcorr_coord_eq_M_u_corr_single} --- \lean{LeanSlt/NNGPResNet/Correlated/SphereChaining.lean}
\item Final correlated high-probability theorem: \lean{LeanSlt.NNGPResNet.Correlated.corr_sphere_highProb_bound} --- \lean{LeanSlt/NNGPResNet/Correlated/SphereChaining.lean}
\end{itemize}

\subsection*{Module aggregators}
\begin{itemize}
\item IID exports: \lean{LeanSlt.NNGPResNet.Main} --- \lean{LeanSlt/NNGPResNet/Main.lean}
\item Correlated exports: \lean{LeanSlt.NNGPResNet.Correlated.Main} --- \lean{LeanSlt/NNGPResNet/Correlated/Main.lean}
\item Top-level import hook: \lean{LeanSlt.lean}.
\end{itemize}


\begin{thebibliography}{99}

\bibitem{liu2026inverse}
Y.~Liu, S.~Kangaslahti, Z.~Liu, and J.~Gore.
\newblock Inverse depth scaling from most layers being similar.
\newblock \emph{arXiv preprint arXiv:2602.05970}, 2026.

\bibitem{zhang2026sltlean}
Y.~Zhang, J.~D. Lee, and F.~Liu.
\newblock Statistical learning theory in Lean~4: empirical processes from scratch.
\newblock \emph{arXiv preprint arXiv:2602.02285}, 2026.
